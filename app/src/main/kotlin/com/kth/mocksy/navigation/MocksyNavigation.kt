...
import com.kth.mocksy.feature.article.DetailScreen
import com.kth.mocksy.feature.home.HomeScreen
 ...
 *
 */
fun NavGraphBuilder.mocksyNavigation(sharedTransitionScope: SharedTransitionScope) {
    with(sharedTransitionScope) {
         ...
         */
        composable<MocksyScreen.Home> {
            HomeScreen(animatedVisibilityScope = this)
        }

        composable<MocksyScreen.Detail>(
            typeMap = MocksyScreen.Detail.typeMap,
        ) {
