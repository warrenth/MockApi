...
import com.kth.mocksy.navigation.MocksyNavHost
 ...
 */
@Composable
fun MockApiMain(composeNavigator: AppComposeNavigator<MocksyScreen>) {
    ArticleTheme {
        ...
        // Navigation Graph 설정
        MocksyNavHost(navHostController = navHostController)
    }
}
